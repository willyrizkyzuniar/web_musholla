...
<h2 class="ml-2">Form Tambah Daftar Kegiatan</h2>

<div class="container-fluid">
    <div class="col">

        <form class="ml-2" action="/kegiatan/save" method="post">
            <?= csrf_field(); ?>
            ...
            <div class=" row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control <?= ($validation->hasError('pengisi_acara')) ? 'is-invalid' : '' ?>" id="pengisi_acara" name="pengisi_acara" value="<?= old('pengisi_acara'); ?>">
                    <div id="validationServer03Feedback" class="invalid-feedback">
